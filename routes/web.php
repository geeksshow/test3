...
Route::post('/email/send-otp', [EmailVerificationController::class, 'sendOTP'])->middleware('throttle:3,1')->name('email.send-otp');
Route::post('/email/verify-otp', [EmailVerificationController::class, 'verifyOTP'])->middleware('throttle:5,1')->name('email.verify-otp');
...
Route::post('/api/forgot-password', [App\Http\Controllers\Auth\ForgotPasswordController::class, 'sendOTP']);
